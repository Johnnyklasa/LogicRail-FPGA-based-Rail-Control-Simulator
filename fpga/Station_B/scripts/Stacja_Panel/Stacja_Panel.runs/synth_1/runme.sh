...
HD_PWD='C:/test_2/LogicRail-FPGA-based-Rail-Control-Simulator/fpga/Station_B/scripts/Stacja_Panel/Stacja_Panel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TopPanel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TopPanel.tcl
