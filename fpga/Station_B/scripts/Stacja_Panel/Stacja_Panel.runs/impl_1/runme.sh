...
HD_PWD='C:/test_2/LogicRail-FPGA-based-Rail-Control-Simulator/fpga/Station_B/scripts/Stacja_Panel/Stacja_Panel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TopPanel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TopPanel.tcl -notrace
